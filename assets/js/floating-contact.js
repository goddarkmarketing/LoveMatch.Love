...
(function () {
  ...
  var lisaImage = "assets/talk-with-lisa.png";
  ...
  host.innerHTML =
    '<div class="floating-contact-panel" id="floatingContactPanel" role="dialog" aria-labelledby="floatingContactTitle" aria-modal="false">' +
      '<div class="floating-contact-head">' +
        '<p class="floating-contact-title" id="floatingContactTitle">Talk with Lisa</p>' +
      ...
      '<div class="floating-contact-body">' +
        ...
        icoLine +
        "<span>Talk with Lisa on Line</span></a>" +
      ...
      "</div>" +
    "</div>" +
    '<button type="button" class="floating-contact-fab" id="floatingContactToggle" aria-expanded="false" aria-controls="floatingContactPanel" title="Talk with Lisa" aria-label="Talk with Lisa">' +
    '<img class="floating-contact-fab-img" src="' + lisaImage + '" alt="" aria-hidden="true" decoding="async">' +
    '<span class="floating-contact-fab-text">Talk with Lisa</span>' +
    "</button>";
